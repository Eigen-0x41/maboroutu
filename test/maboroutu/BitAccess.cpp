...
BOOST_AUTO_TEST_CASE(BitAccess) {
  ...
  using access1 = bitAccess_type::main_key_t<0, 4>;
  using access2 = bitAccess_type::key_t<access1, 4>::value_type;
  using access3 = bitAccess_type::main_key_t<0, 8>::value_type;

  using access4 = bitAccess_type::main_key_t<0, 16>::value_type;  // allow
  using access5 = bitAccess_type::key_t<access1, 12>::value_type; // allow
